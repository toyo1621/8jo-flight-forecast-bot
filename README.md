...
**公開サイト:** [八丈島フライト統計予想](https://toyo1621.github.io/8jo-flight-forecast-bot/)
...
- 主予測とJMA参考値の差が20ポイント以上なら「モデル差注意」を表示
...
JMA参考就航確率はこのA〜E判定には含めません。主予測との差が20ポイント以上の場合のみ、リスク欄へ「モデル差注意」を表示します。
