...
八丈島便は、風や視程などの気象条件によって、条件付きでの就航、引き返し欠航、欠航になることがあります。公式の運航判断が出る前にも、現在の予報が過去のどのような運航状況に近いのかを把握し、予定を考える際の参考にできる情報を作ることが目的です。
