...
- 八丈島側・羽田側の気圧やアンサンブルの大きな下振れから「台風接近リスク」を表示
...
台風接近リスクは、八丈島側または羽田側の気圧が低い場合、またはGFS・ECMWFアンサンブルの中央80%幅が60ポイント以上かつ下位10%が25%以下の場合に表示します。この場合は主予報、GFS、ECMWF、JMAの表示確率に0.6を掛け、羽田側の悪化も運航リスクとして扱います。
