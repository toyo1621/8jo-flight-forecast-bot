...
視程3 km以上5 km未満では0.8、1 km以上3 km未満では0.7、1 km未満では0.5を掛けます。降水量2 mm/h以上では0.85、8 mm/h以上では0.7を掛けます。突風と平均風速の補正は同時には掛けず、最大瞬間風速15 m/s以上を優先し、20 m/s以上では0.55、それ以外で平均風速10 m/s以上なら強風補正を掛けます。
