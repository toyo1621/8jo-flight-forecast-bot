...
ACCESS_STATS_DAYS = 7
DEFAULT_ACCESS_STATS_FILE = Path(__file__).resolve().parent.parent / ".cache" / "access_stats.json"
UTC = timezone.utc
...
if __name__ == "__main__":
    if sys.argv[1:] == ["--mark-stale"]:
        ...
        raise SystemExit("usage: python -m flight_forecast.access_stats [--mark-stale]")
    else:
